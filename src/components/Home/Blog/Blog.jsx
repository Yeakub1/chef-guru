      ...
      <div ref={ref} className="px-5">
        ...
        <div className="mt-5">
          <h4>
            ...
            components may not behave as expected. Hence, it is required to use
        ...
        <div className="mt-5">
          ...
          <h4>
            ...
            small framework that sits on top of Node.jss web server
            functionality to simplify its APIs and add helpful new features. It
            makes it easier to organize your applications functionality with
            middle ware and routing. It adds helpful utilities to Node.jss HTTP
            objects. It facilitates the rendering of dynamic HTTP objects.
          </h4>
        </div>
        ...
        <div className="mt-5">
          <h4>
            <span className="text-primary">
              4. custom hook and create a custom hook :
            </span>{" "}
        ...
        <ReactToPrint 
          trigger={() => {
            return <Button className='mt-3'>Print this</Button>;
          }}
          content={() => ref.current}
        />
      </div>
